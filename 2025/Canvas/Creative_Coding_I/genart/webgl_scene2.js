...
const sketch = ({ context }) => {
    ...
    void main() {
    vUv = uv;
    vec3 pos = position.xyx * sin(time);
    ...
    // scene.add(new THREE.DirectionalLight("crimson", 0.5));
    ...
    const easingFn = BezierEasing(0.25, 0.1, 0.25, 1);
    ...
    return {
        ...
        render({ playhead, time }) {
            ...
            // scene.rotation.z = eases.quadInOut(playhead) * Math.PI * 2;
            const t = Math.sin(playhead * Math.PI);
            scene.rotation.z = easingFn(t);
            // scene.rotation.y = t;
